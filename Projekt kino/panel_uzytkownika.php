...
echo"<a style='text-decoration:none'   href='show_seans.php?seans_id=$id'>";
	...
	<?php
	echo"<div class='panik'>";
	echo'<li class="Logowanie1"><a href="showzamowienie.php">Status zamówienia biletu</a></li>';
	
		
	echo'<li class="Logowanie22"><a href="wyswietlanie_koszyka.php">Przejdź do koszyka</a></li>';
	echo'<li class="Logowanie33"><a href="index.php">Przejdż do kina</a></li>';
